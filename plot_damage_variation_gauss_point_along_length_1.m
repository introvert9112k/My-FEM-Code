...
close all; clc;
load('Mode_I_80by80_Beta_50_eta_5_LargeLength_LocalStrain');
...
% Large Length Scale
step1 = 26; step2 = 35; step3 = 63; step4 = 98; step5 = 58; step6 = 150;

check_elem = ((numx/2)+1):numx;
...
axis([0 9 0 0.6]);
hold on
plot(((forcevdisp(1,step1))/L)*1e3,(forcevdisp(2,step1))/(L*E*kappa0),'*k','LineWidth',1);
hold on
plot(((forcevdisp(1,step5))/L)*1e3,(forcevdisp(2,step5))/(L*E*kappa0),'*k','LineWidth',1);
hold on
plot(((forcevdisp(1,step6))/L)*1e3,(forcevdisp(2,step6))/(L*E*kappa0),'*k','LineWidth',1);
...
for del=1:1:numelem    
    if (ismember(del,check_elem))              
            a = (del-1)*4;
            omega(it,1) = DAMAGE_DATA(a+4,step1);
