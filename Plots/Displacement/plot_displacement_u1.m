...
horizontal_displacement_data = zeros(nRows/2,n1*n2);

for k1 = 1:n1
    for k2 = 1:n2
        st = steps(k1,k2);
        for i = 1 : 2 :nRows 
            horizontal_displacement_data((i+1)/2,st) = DISP_DATA(i,st);
        end 
    end
end 
...
for k1 = 1:n1
    for k2 = 1:n2
            ...
            patch('Vertices',nodes_locations,'Faces',tri,'FaceVertexCData',horizontal_displacement_data(:,st));  
...
sgtitle('Horizontal Displacement');
end 