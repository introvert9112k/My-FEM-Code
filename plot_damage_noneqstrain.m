...
function plot_damage_noneqstrain
...
% plot((0.117600000000000/L)*1e3,65.7553589049458/(L*E*kappa0),'*k','LineWidth',1);
% plot((0.207800000000000/L)*1e3,26.1267872914772/(L*E*kappa0),'*k','LineWidth',1);


% Check Step
%     if step<=5 
%         ubar = 1.2e-3;
%     elseif step>5 && step<=65
%         ubar = 1e-4;
%     elseif step>65 && step<=145
%         ubar = 3e-4;         
%     elseif step>145
%         ubar = 1.2e-3;
%     end
...
% function plot_mesh(X,connect,elem_type,linespec) plots a nodal mesh and an associated connectivity. 
% X is the nodal coordinates, connect is the connectivity, and
% elem_type is either 'L2', 'L3', 'T3', 'T6', 'Q4', or 'Q9' depending on the element topology.
